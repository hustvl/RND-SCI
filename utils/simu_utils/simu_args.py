...
def simu_par_args():
    ...
    # Data specifications
    parser.add_argument('--data_root', type=str, default='/data/HSI/', help='dataset directory')

    # Saving specifications
    parser.add_argument('--outf', type=str, default='./exp/rnd_saunet_1stg/', help='saving_path')
