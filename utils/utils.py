...
def model_input_setting(opt):
    if 'mst' in opt.method:
        opt.input_setting = 'H'
        opt.input_mask = 'Phi'

    if 'tsa_net' in opt.method:
        opt.input_setting = 'HM'
        opt.input_mask = None
    ...
    if 'dauhst' in opt.method or 'saunet' in opt.method:
        opt.input_setting = 'Y'
        opt.input_mask = 'Phi_PhiPhiT'
